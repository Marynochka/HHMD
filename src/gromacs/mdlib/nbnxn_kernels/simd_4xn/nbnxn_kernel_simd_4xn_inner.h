...
/*    SimdReal hhmd_coeff = SimdReal(ic->hhmd_G_coeff);
    if (ic->hhmd_G_scale) {
        dx_S0       = dx_S0*hhmd_coeff;
        dy_S0       = dy_S0*hhmd_coeff;
        dz_S0       = dz_S0*hhmd_coeff;
        dx_S1       = dx_S1*hhmd_coeff;
        dy_S1       = dy_S1*hhmd_coeff;
        dz_S1       = dz_S1*hhmd_coeff;
        dx_S2       = dx_S2*hhmd_coeff;
        dy_S2       = dy_S2*hhmd_coeff;
        dz_S2       = dz_S2*hhmd_coeff;
        dx_S3       = dx_S3*hhmd_coeff;
        dy_S3       = dy_S3*hhmd_coeff;
        dz_S3       = dz_S3*hhmd_coeff;
    }
*/
